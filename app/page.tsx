    ...
    >
      ...
      <div className="flex flex-col space-y-7 mx-12">
        <div className="flex space-x-6 bg-[#B5935B] rounded-lg justify-around items-center py-16">
          ...
          <img src="Subjects/transfiguration.png" className="h-44 w-44 rounded-2xl" />
          <img src="Subjects/alchemy.png" className="h-44 w-44 rounded-2xl" />
          <img src="Subjects/dd.png" className="h-44 w-44 rounded-2xl" />
        </div>
        <div className="flex space-x-6 bg-[#B5935B] rounded-lg justify-around items-center py-16">
